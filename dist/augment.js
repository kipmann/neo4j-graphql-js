...
var possiblyAddFilterInput = function possiblyAddFilterInput(
  ...
  if (
    ...
    var name = '_' + astNode.name.value + 'Filter';
    var filterFields = buildFilterFields(
      name,
      astNode,
      typeMap,
      resolvers,
    ...
    if (typeMap[name] === undefined && filterFields.length) {
      typeMap[name] = (0, _graphql.parse)(
        'input ' + name + ' {' + filterFields.join('') + '}'
      );
    }
...
var buildFilterFields = function buildFilterFields(
  filterType,
  astNode,
  typeMap,
  resolvers,
  ...
  var fields = astNode.fields;
  var filterFields = fields.reduce(function(acc, t) {
    ...
    if (
      ...
      if (!isList) {
        if (valueTypeName === 'ID' || valueTypeName == 'String') {
          ...
          (0, _utils.getFieldDirective)(t, 'relation') &&
          shouldAugmentType(config, 'query', valueTypeName)
        ) {
...
var possiblyAddTypeFieldArguments = function possiblyAddTypeFieldArguments(
  ...
  fields.forEach(function(field) {
    relationTypeName = (0, _utils._getNamedType)(field).name.value;
...
var getFieldArgumentsFromAst = function getFieldArgumentsFromAst(
  ...
  var args = [paginationArgs]
    .concat((0, _toConsumableArray3.default)(fieldArgs))
    .reduce(function(acc, t) {
      acc.push((0, _graphql.print)(t));
      return acc;
    }, [])
